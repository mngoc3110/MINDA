...
# folder chứa JSON
json_dir = "/var/www/minda/student-center/backend/temp_json"
...
for fpath in json_files:
    ...
    # Xoá bài cũ có cùng tên trong folder (để upload đè nếu cần thiết)
    ...
    if old:
        ...
        print(f"Creating new assignment: {title}")
...
db.commit()
print("Thành công! Đã đưa dữ liệu vào DB.")
